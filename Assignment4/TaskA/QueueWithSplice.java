public final class QueueWithSplice<T> implements QueueInterface<T>{
	   ...
	   public QueueWithSplice()
	   {
	      this(DEFAULT_CAPACITY);
	   } // end default constructor

	   public QueueWithSplice(int initialCapacity)
	   {
	   ...
	   private void checkCapacity(int capacity)
	   {
	    ...
	    public void splice(QueueInterface<String> anotherQueue){
	          if(anotherQueue.isEmpty())
	              throw new EmptyQueueException();
	          while(!anotherQueue.isEmpty()) {
	              T temp = (T) anotherQueue.dequeue();
	              enqueue(temp);
	          }
	    }
	    public void display()
